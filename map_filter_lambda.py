# def summ_of_two_numbers(x):
#     return x + x
#
#
# number_list = [1, 2, 3, 4, 5, 6, 7]
#
# result = map(summ_of_two_numbers, number_list)
# print(result)
#
# for item in result:
#     print(item)
#
# print(list(map(summ_of_two_numbers, number_list)))
...
#         return False
#
# string_list = ['hi', 'Vadim', 'name', 'boolean', 'old']
