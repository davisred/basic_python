...
# print(name_and_age)
# week_days: object = 'There are 7 days in a week: {5}, {0}, {3}, {1}, {2}, {4}, {6}.'\
#     .format('Monday','Wednesday', 'Thursday', 'Tuesday', 'Friday', 'Sunday', 'Saturday')
# print(week_days)
# week_days: object = 'There are 7 days in a week: {mo}, {tu}, {we}, {th}, {fr}, {sa}, {su}.'\
#     .format(mo = 'Monday', we = 'Wednesday', th =  'Thursday', tu =  'Tuesday',
#             fr = 'Friday', su = 'Sunday', sa = 'Saturday')
# print(week_days)
# week_days: object = 'There are 7 days in a week: {su}, {su}, {su}, {su}, {su}, {su}, {su}.'\
#     .format(mo = 'Monday', we = 'Wednesday', th =  'Thursday', tu =  'Tuesday',
#             fr = 'Friday', su = 'Sunday', sa = 'Saturday')
# print(week_days)
...
# float_result = 1000 / 7
# print(float_result)
# print('The result of division is: {0:1.2f}'.format(float_result))
# print('''
#  {0:10.2f} {1:10.2f} {2:10.2f}
#  {3:10.2f} {4:10.2f} {5:10.2f}
#  {6:10.2f} {7:10.2f} {8:10.2f}
# '''.format(1.45778, 345.232324, 34.2344, 1234.23,
#            1.45778, 345.232324, 34.2344, 1234.23,
#            456,934373))
